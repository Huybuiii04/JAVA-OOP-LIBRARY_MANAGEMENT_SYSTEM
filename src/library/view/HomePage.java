...
import library.manager.LibManagement;
...
public class HomePage extends JFrame implements ActionListener {
	...
	public HomePage(int choose, String title, String ID) {
		...
		btnShowPass.setIcon(new ImageIcon(HomePage.class.getResource("/library/view_lib/Icon/invisible_16px.png")));
		...
		btnShowPass1
				.setIcon(new ImageIcon(HomePage.class.getResource("/library/view_lib/Icon/invisible_16px.png")));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(btnLogIn))
			...
			if (count++ % 2 == 0) {
				...
				btnShowPass
						.setIcon(new ImageIcon(HomePage.class.getResource("/library/view_lib/Icon/eye_16px.png")));
			} else {
				txtPassWord1.setEchoChar('*');
				btnShowPass.setIcon(
						new ImageIcon(HomePage.class.getResource("/library/view_lib/Icon/invisible_16px.png")));
			}
